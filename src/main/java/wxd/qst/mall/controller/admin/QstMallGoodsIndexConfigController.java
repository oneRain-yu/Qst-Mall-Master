...
public class QstMallGoodsIndexConfigController {
    ...
    public String indexConfigsPage(HttpServletRequest request, @RequestParam("configType") int configType) {
        ...
        return "admin/qst_mall_index_config";
    }
    ...
    public Result list(@RequestParam Map<String, Object> params) {
        ...
        return ResultGenerator.genSuccessResult(qstMallIndexConfigService.getConfigsPage(pageUtil));
    }
    ...
    public Result save(@RequestBody IndexConfig indexConfig) {
        ...
        String result = qstMallIndexConfigService.saveIndexConfig(indexConfig);
    ...
    public Result update(@RequestBody IndexConfig indexConfig) {
        ...
        String result = qstMallIndexConfigService.updateIndexConfig(indexConfig);
        if (ServiceResultEnum.SUCCESS.getResult().equals(result)) {
            return ResultGenerator.genSuccessResult();
        } else {
            return ResultGenerator.genFailResult(result);
    ...
    public Result info(@PathVariable("id") Long id) {
        IndexConfig config = qstMallIndexConfigService.getIndexConfigById(id);
        if (config == null) {
    ...
    public Result delete(@RequestBody Long[] ids) {
        ...
        if (qstMallIndexConfigService.deleteBatch(ids)) {
            return ResultGenerator.genSuccessResult();
        } else {
