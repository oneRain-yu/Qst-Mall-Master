$(function () {
    $("#jqGrid").jqGrid({
        ...
        postData: {
            ...
            paramGoodsIntro : $('#paramGoodsIntro').val(),
            paramBeginTime : $('#paramBeginTime').val(),
            paramEndTime : $('#paramEndTime').val(),
            paramSupplier : $('#paramSupplier').val()
        },
        colModel: [
            ...
            {label: '供应商', name: 'supplier', index: 'supplier', width: 60},
            //{label: '商品售价', name: 'sellingPrice', index: 'sellingPrice', width: 60},
            {label: '商品价格', name: 'originalPrice', index: 'originalPrice', width: 60},
            {
                label: '上架状态',
